...
export class CreateCheckInsAndScanningDevicesTables1723000000001 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query('CREATE INDEX "idx_scanning_devices_tenant_event" ON "scanning_devices" ("tenant_id", "event_id")');
    await queryRunner.query('CREATE UNIQUE INDEX "uq_scanning_devices_tenant_event_device" ON "scanning_devices" ("tenant_id", "event_id", "device_id")');
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query('DROP INDEX IF EXISTS "uq_scanning_devices_tenant_event_device"');
    await queryRunner.query('DROP INDEX IF EXISTS "idx_scanning_devices_tenant_event"');
